(define (problem p3-sim)
  ...
  (:init
    ...
    (clau-multi-usos clau1)     ; vermell
    (clau-un-us clau2)     ; verd
    (clau-un-us clau3)     ; verd
    (clau-un-us clau4)  ; porpra
    (clau-un-us clau5)  ; porpra
    (clau-un-us clau6)  ; arc_de_sant_marti
